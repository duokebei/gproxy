...
use crate::openai::create_image::types::{
    OpenAiApiErrorResponse, OpenAiCreateImageResponseBody, OpenAiResponseHeaders,
};

/// Successful body for OpenAI `images.generate` endpoint.
pub type ResponseBody = OpenAiCreateImageResponseBody;
