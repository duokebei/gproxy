...
// Per-protocol model_list/model_get: all served from local models table by
// default. Admins can pull from upstream via /admin/models/pull instead of
// hitting upstream on every request.
